...
export default function ServiceCategoryManager({ onClose, onCategoryUpdate }: ServiceCategoryManagerProps) {
  ...
  const loadCategories = async () => {
    try {
      const [serviceCats, services] = await Promise.all([
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-2xl w-full max-w-5xl max-h-[95vh] overflow-hidden flex flex-col">
