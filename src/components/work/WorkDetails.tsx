...
export default function WorkDetails({ workId, onClose, onUpdate, onEdit }: WorkDetailsProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {activeTab === 'recurring' && work.is_recurring && (
            <RecurringTab
              ...
              onUpdatePeriodStatus={updateRecurringInstanceStatus}
      ...
      <TimeLogModal
        isOpen={showEditTimeLogModal}
        onClose={() => {
          setShowEditTimeLogModal(false);
          setEditingTimeLog(null);
        }}
        onSubmit={handleEditTimeLog}
        form={timeForm}
        setForm={setTimeForm}
        staff={staff}
        isEditMode={true}
      ...
      <RecurringPeriodModal
        ...
        onSubmit={handleCreateRecurringInstance}
        form={recurringForm}
      ...
      <RecurringPeriodModal
        ...
        onSubmit={handleEditRecurringInstance}
        form={recurringForm}
        setForm={setRecurringForm}
        isEditMode={true}
      />
