/*
  # Update Period Generation to Include Work Task Templates
  
  ## Changes
  Updates the auto_generate_next_period_for_work function to use the new
  copy_tasks_to_period_with_templates function that includes both service
  templates and work-level task templates.
*/

-- Update the auto_generate_next_period_for_work function to use new function
...
BEGIN
  ...
  -- Copy tasks (both service templates and work templates)
