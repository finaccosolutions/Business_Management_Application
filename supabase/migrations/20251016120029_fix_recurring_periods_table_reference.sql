/*
  # Fix recurring periods table reference in triggers

  1. Problem
    - Trigger functions reference "recurring_periods" table which doesn't exist
    - The actual table is "work_recurring_instances"
    - This causes errors when creating recurring work entries

  2. Solution
    - Update copy_service_tasks_to_work function to use work_recurring_instances
    - Update handle_new_recurring_work_initial_period function to use work_recurring_instances
    - Update column names to match work_recurring_instances schema

  3. Tables Referenced
    - work_recurring_instances (not recurring_periods)
...
-- Recreate copy_service_tasks_to_work with correct table name
...
-- Recreate handle_new_recurring_work_initial_period with correct table name
