/*
  # Fix service_tasks Column Reference

  ## Problem
  The copy_tasks_to_period_with_templates function references st.display_order 
  but service_tasks table has column named sort_order, not display_order.
  
  Error: column st.display_order does not exist

  ## Solution
  Change st.display_order to st.sort_order in the ORDER BY clause.
*/
