/*
  # Fix Backfill Periods Function - Correct Output Selection

  ## Issue  
  - SELECT statement needed to use * to match function output
  - Three columns returned: period_start_date, period_end_date, period_name
*/
...
BEGIN
  ...
  WHILE TRUE LOOP
    ...
    v_next_start := v_calc_result.period_start_date;
    v_next_end := v_calc_result.period_end_date;
    v_next_name := v_calc_result.period_name;
