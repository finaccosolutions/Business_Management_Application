/*
  # Complete Database Schema with Notes Support for Leads

  ## Overview
  Comprehensive database schema including all tables with proper support for:
  ...
  ## Key Features
  - customer_notes table supports both customers AND leads
  - communications table supports both customers AND leads
